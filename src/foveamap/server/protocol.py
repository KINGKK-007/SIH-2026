        ...
        out.append(
            {
                ...
                "side": int(side),
                "iy": iy.astype(np.int16).tolist(),
                "ix": ix.astype(np.int16).tolist(),
                "ground_z": cells["ground_z"].tolist(),
                "top_z": cells["top_z"].tolist(),
                "clearance": cells["clearance"].tolist(),
                "cls": cells["cls"].tolist(),
                "moving_frac": cells["moving_frac"].tolist(),
