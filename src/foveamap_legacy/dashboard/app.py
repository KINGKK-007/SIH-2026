...
from foveamap_legacy.derive.hazards import HazardReport, inject_synthetic_hazards
from foveamap_legacy.derive.layers import compute_derived_layers
from foveamap_legacy.eval.metrics import compute_accuracy_by_range, compute_iou_by_range
...
from foveamap_legacy.motion.cluster import ObjectBox, cluster_motion_candidates
...
def _render_dashboard_frame(
    ...
    from foveamap_legacy.viz.render import _composite_rings
